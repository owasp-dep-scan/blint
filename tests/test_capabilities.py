...
def test_check_count_and_engine_parity(index):
    ...
    assert len(checks) == 48  # rules.yml today (20 + the four provisioning/objc-load rules; W0.3 removed the five PE property rules, W1.1 added CHECK_BUILD_PATH_LEAK, W1.4 added CHECK_TLS_CALLBACKS, W2.2 added CHECK_SIGNATURE_NOT_TIMESTAMPED and CHECK_WEAK_SIGNATURE_DIGEST, W2.4 added CHECK_SELF_SIGNED, CHECK_SIGNATURE_UNKNOWN_ROOT, CHECK_KERNEL_SIGNING_CLASS and CHECK_SIGNER_MISMATCH, W5.6 added CHECK_PRIVILEGED_HOST_PLUGIN, CHECK_UNSIGNED_HOST_PLUGIN and CHECK_LSA_PLUGIN, W4.1 added CHECK_MSIX_RESTRICTED_CAPABILITY, W5.2 added CHECK_HVCI_COMPATIBLE and CHECK_BOOT_START_INTEGRITYCHECK, W5.3 added CHECK_KNOWN_VULNERABLE_DRIVER, M1.1 added CHECK_MACOS_HOST_PLUGIN and CHECK_AUDIO_PLUGIN_NETWORK, A3/C1 added CHECK_ANDROID_TEXTREL, CHECK_ANDROID_WX_LOAD, CHECK_ANDROID_NO_SONAME, CHECK_ANDROID_ABS_NEEDED, CHECK_ANDROID_PAGE_16K and CHECK_ANDROID_EXTRACT_NATIVE_LIBS, A3/C2 added CHECK_ANDROID_BTI_PAC and CHECK_ANDROID_MEMTAG)
