...
HARDWARE_PRIMITIVE_INSTRUCTIONS = (
    "rdmsr",
    "wrmsr",
    "rdpmc",
    "invd",
...
SECURE_DEVICE_CREATION_IMPORTS = {
    "iocreatedevicesecure",
    "wdmlibiocreatedevicesecure",
    "wdfdeviceinitassignsddlstring",
}

DEVICE_CREATION_IMPORTS = {
    "iocreatedevice",
...
def _collect_import_names(metadata: dict) -> set:
...
def _collect_string_values(metadata: dict) -> list:
...
def _has_hardware_primitive(import_names: set, metadata: dict):
...
def review_binary_metadata(review_binary_list, metadata: dict, evidence_limit: int):
