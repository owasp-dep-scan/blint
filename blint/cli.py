...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=False,
        dest="no_cache",
        help="Do not use the content-addressed parse metadata cache. Results "
        "are recomputed for every binary even when it was analyzed before "
        "with the same blint version and options.",
    )
    parser.add_argument(
        "-q",
        "--quiet",
