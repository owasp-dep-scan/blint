...
| `exename-wasm-report.json` | **Raw WASM parser report** for WebAssembly inputs.                                              | Generated for `.wasm` files and contains the full `wasm_tools` parser output, including section/function/instruction detail.                                                       |
